...
// O(n) where n is the number of elements in the numbers array

// Q: What is the space complexity?
// ANSWER:

// the space complexity is O(1) because theres no new data being created within a loop
...
// O(n) since there is just one loop

// Q: Given an array of numbers, what is the space complexity of this function?
// ANSWER:
// O(2) since you are defining multiple varieables, but none within a loop
...
// ANSWER: yes, you do not need to loop through the array to get the fourth element
const fourth = (numArr) => numArr[4]
// the time complexity for this function is O(1) (constant)
...
// ANSWER: space complexity is O(1) since the variables are defined once
...
// Q: What is the time complexity of this function?
// ANSWER: time complexity is O(n) since it depends directly on the size of the number passed in

// Q: What is the space complexity of this function?
// ANSWER: the space complexity is O(1) since theres a constant number of variables being defined
...
// Q: What is the time complexity of this function?
// ANSWER:time complexity is O(n^2) since theres a nested for loop

// Q: What is the space complexity of this function?
// ANSWER: space complexity is O(n) since theres new variables being defined in the for loop
...
// Q: What is the time complexity of this function?
// ANSWER: time complexity is O(n^2 ) because of the nested for loops

// Q: What is the space complexity of this function?
// ANSWER:space complexity is O(n)  because theres variables assigned in the for loop (j)
...
// ANSWER: time complexity is O(n) since it functions the same as a for loop and is dependent on the size of the array

// Q: What is the space complexity of the filter higher-order function?
// ANSWER: space complecity is O(1) since you have to define a new variable only once
...
// ANSWER: O(1) since it doesnt matter the length of the array
...
function arrInception(parentArr) {
  ...
  // Q: What is the space complexity of this function?
  // ANSWER: O(n) since you are defining new variables inside a for loop
...
// Q: What is the space complexity of this function?
// ANSWER: O(n) since youre defining variables inside a for loop


// Q: Is it possible to improve this function's space complexity? If it is, write a new function below.
// ANSWER: yes

const squareArr = (numsArr) => {
  let squares = [];
  for (let i = 0; i < array.length; i++) {
    squares.push(numsArr[i] * numsArr[i])
  }
  return squares;
}
// or if you dont want to dislay them in an array
const square = arr => {
  for (let i = 0; i < array.length; i++) {
    return arr[i] * arr[i];
  }
...
// ANSWER: they do not have the same space complexity, but both are constant


// Q: What is the space complexity of each? 
// ANSWER - countLetters: O(2)
// ANSWER - countLettersRoundTwo: O(1)


// Q: Explain how you came to your conclusions about the space complexity of each function. 
// ANSWER: no variables are defined within the loops, so it is just the number of variables defined as a constant
// the first one defines 2 variables, th second one defines 1 only
